 ...
 *   announce-bar → cat-strip → hero → local-promise-strip → just-listed →
 *   whatsapp-cta → how-section → categories → featured → city-section →
 *   diaspora-section-home → sellers-section-home → stats-bar → final-cta →
 *   home-testimonials → richPageFooter()
 *
 * Where the prototype uses helpers (productCard, productImage, categoryTile,
 * renderPrice) the same shapes are inlined here.
 *
 * Per docs/prototype/Vendoora_App.html line 11582 "renderPrice respecting
 * audience" — defaulting to 'local' audience (LRD primary, USD secondary)
 * at a 180 LRD/USD reference rate.
 */
...
/** Mirrors renderPrice() — local audience: L$ primary, ≈ $X.XX USD secondary. */
function PriceTag({ usd, compareAt }: PriceData) {
  return (
    <>
...
export default async function HomePage() {
  const [featured, justListed] = await Promise.all([
    // "Featured" — top 4 published products. Prototype uses `SEED.products.slice(0, 4)`.
    ...
    // "Just listed today" — newest 6 products. Prototype hardcodes 6 sample
    // cards (Vlisco, Palm Butter, etc.); we pull from real seed so the names
    // are accurate to the catalogue and times-ago/seller-cities are real.
    prisma.product.findMany({
      where: { status: 'PUBLISHED', moderation_status: 'APPROVED', deleted_at: null },
    ...
    <div className="screen-container">
      ...
      <section className="hero">
        <div>
          ...
          <p className="lede">
            On Vendoora, your money stays in escrow until the driver brings your package to your door — and you give them your code.{' '}
            <strong>No code, no package. No package, no payout.</strong> That&apos;s how we keep every order safe.
          </p>
                ...
                <div className="phone-content">
                  <div className="phone-sms-card">
                    ...
                    <div className="sms-body">
                      Your driver Joseph is on his way with your order from <strong>Mariama&apos;s Boutique</strong>. Give him this code at the door:
                    </div>
      ...
      {/* ============ FEATURED BY CITY (illustrative — production wires to seller-near-buyer query) ============ */}
      ...
      <section className="diaspora-section-home">
        <div>
          ...
          <p>
            ...
            goods you actually picked, from a verified seller, with proof-of-delivery sent
        ...
        <div className="home-testimonials-grid">
          <div className="testimonial-card">
            <p className="testimonial-quote">
              ...
              ship. But the code came, the driver came, and the wrapper was exactly what I
              ordered. Now I shop here every week.
            </p>
          ...
          <div className="testimonial-card">
            <p className="testimonial-quote">
              ...
              things now, not just money — wrappers, food, medicine. I see the photo of her
              holding the package. That&apos;s priceless.
            </p>
            <div className="testimonial-author">
...
// Time-since labels mirror the prototype's hand-curated set so the homepage
// "feels" like products just landed; production wires this to `created_at`.
const JUST_LISTED_TIME_AGO = ['4m ago', '12m ago', '32m ago', '1h ago', '2h ago', '3h ago'];

// Image-tone classes the prototype uses for the placeholder gradients.
const TONE_BY_INDEX = ['wrap', 'food', 'beauty', 'crafts', 'home', 'electronics'];

// Sinkor city sellers — prototype hardcodes these. Production wires to a
// query like "top sellers by avg delivery within zone".
const STUB_CITY_SELLERS = [
  {
    ...
    initials: 'KB',
    tier: 3,
    meta: 'Sinkor · ★ 4.7 (412) · 2.4 km away',
    products: 89,
    avgDelivery: '38min',
  },
  {
    name: 'Anthony’s Goods',
    banner: 'c',
    initials: 'AG',
    tier: 3,
    meta: 'Sinkor · ★ 4.8 (612) · 1.8 km away',
    products: 67,
    avgDelivery: '32min',
  },
  {
    name: 'Grace’s Beauty Bar',
    banner: 'd',
    initials: 'GB',
    tier: 2,
    meta: 'Sinkor · ★ 4.6 (218) · 3.1 km away',
    products: 52,
    avgDelivery: '45min',
  },
  {
    ...
    initials: 'TF',
    tier: 3,
    meta: 'Sinkor · ★ 4.9 (1,247) · 0.9 km away',
    products: 134,
    avgDelivery: '22min',
  },
];
